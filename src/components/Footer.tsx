...
const Footer = () => {
  ...
  return <footer className="py-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">Product Manager passionate about building impactful products and mentoring the next generation of PMs.</p>
            </div>
